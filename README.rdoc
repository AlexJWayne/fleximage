...
Uses the Rails I18n to translate error messages. 
While they still can be set by using the 'missing_image_message' and 'invalid_image_message' accessors, it's better to configure them in your locale:
