...
Gem::Specification.new do |s|
  ...
  s.authors = ["Alex Wayne"]
  s.date = "2009-12-13"
  s.description = "Fleximage is a Rails plugin that tries to make image uploading and rendering super easy."
  s.email = "ruby@beautifulpixel.com"
  s.extra_rdoc_files = [
    "README.rdoc"
  ]
  s.files = [
  ...
  s.homepage = "http://github.com/Squeegy/fleximage"
  ...
  if s.respond_to? :specification_version
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0')
      ...
      s.add_development_dependency("rails", ["= 2.2.2"])
    else
